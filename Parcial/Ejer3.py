...
su nombre, maestros, colores de sable de luz usados y especie. implementar las funciones
...
h) indicar los nombre de los padawans de Qui-Gon Jin y Mace Windu, si los tuvieron. i) Mostrar todos los Jedi que tengan el ranking de Grand Master.
"""
